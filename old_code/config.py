...
CAMERA_WIDTH = _to_int(os.environ.get("CAMERA_WIDTH"), 640)
CAMERA_HEIGHT = _to_int(os.environ.get("CAMERA_HEIGHT"), 480)
CAMERA_FPS = _to_float(os.environ.get("CAMERA_FPS"), 12.0)
CAMERA_FOURCC = os.environ.get("CAMERA_FOURCC", "H264")
_jpeg_quality = _to_int(os.environ.get("CAMERA_JPEG_QUALITY"), 75)
